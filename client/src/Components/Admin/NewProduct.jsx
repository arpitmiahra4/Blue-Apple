      ...
      <Flex gap={"1%"}>
        ...
        <Box w={"80%"} h="90vh" borderRadius={10} bg="black">
          ...
          <Flex gap={5} pl={4} pr={4}>
            ...
            <Input border={"2px solid #f8e68a"} fontSize={25} placeholder="Big Image Url" h={100} onChange={(e)=>setSrc(e.target.value)}/>
            <Box mt={10}>
            <Text fontSize={22} mb={5}>Carousel Product Image</Text>
            <Box display={"grid"} style={{gridTemplateColumns:"repeat(2,190px)"}} gap={5}>
            <Input border={"2px solid #f8e68a"} fontSize={22} h={20} placeholder="Image Url 1" onChange={(e)=>setImg1(e.target.value)}/>
            <Input border={"2px solid #f8e68a"} fontSize={22} h={20} placeholder="Image Url 2" onChange={(e)=>setImg2(e.target.value)}/>
            <Input border={"2px solid #f8e68a"} fontSize={22} h={20} placeholder="Image Url 3" onChange={(e)=>setImg3(e.target.value)}/>
            <Input border={"2px solid #f8e68a"} fontSize={22} h={20} placeholder="Image Url 4" onChange={(e)=>setImg4(e.target.value)}/>
            <Input border={"2px solid #f8e68a"} fontSize={22} h={20} placeholder="Image Url 5" onChange={(e)=>setImg5(e.target.value)}/>
            <Input border={"2px solid #f8e68a"} fontSize={22} h={20} placeholder="Image Url 6" onChange={(e)=>setImg6(e.target.value)}/>
            </Box>
            </Box>
            </Box>
