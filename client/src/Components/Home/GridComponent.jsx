      ...
      <SimpleGrid className={styles.arpit_bgrid}>
        <Box className={styles.arpit_gone}>
          <Box pt={10}>
            ...
            <Text color={"orange"} fontSize={22} fontWeight="normal" mt={"-3"}>
              ULTRA
            </Text>
            <Text color={"black"} fontSize={25} fontWeight="normal">
              Adventure awaits.
            </Text>
        ...
        <Box className={styles.arpit_gtwo}>
          <Box pt={10}>
            ...
            <Text color={"white"} fontSize={25} fontWeight="normal">
              Supercharged by #m2
            </Text>
        ...
        <Box className={styles.arpit_gfive}>
          <Box pt={10}>
            ...
            <Text color={"black"} fontSize={22} fontWeight="normal">
