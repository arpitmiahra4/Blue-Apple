    ...
    <>
      ...
      <Box w={"100%"}>
        ...
        >
          ...
          credit cards.‡ Plus No Cost EMI from most leading banks.‡‡ Shop now
          &gt;
        </Box>
        {/* first box */}
        ...
        <Box w={"100%"} className={styles.arpit_two}>
          <Box pt={5}>
            ...
            <Text color={"black"} fontSize={28} fontWeight="normal">
              Big and bigger
            </Text>
            <Box
        ...
        <Box w={"100%"} className={styles.arpit_third} mt="1%">
          <Box pt={5}>
            ...
            <Text color={"red"} fontSize={25} fontWeight="normal" mt={"-3"}>
              SERIES 8
            </Text>
            <Text color={"white"} fontSize={28} fontWeight="normal">
